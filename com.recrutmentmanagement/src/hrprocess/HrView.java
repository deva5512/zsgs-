...
public class HrView implements HrViewCallBack, Teleportable {

	private HrViewControllerCall hrcontroller;
	private Scanner scanner = new Scanner(System.in);

	public HrView() {
		this.hrcontroller = new HrConroller(this);
	}

	@Override
	public void caller(Object obj) {
		hrcontroller.saveHr(obj);
	...
	private void showCandidates() {
		hrcontroller.showCandidates();
	}

	private void deletPost() {

		Hr hr = hrcontroller.getcurrentHr();
	...
	private void addPost() {
		...
		double price = hrcontroller.getPriceOfPost();

		if (payment(price)) {
			hrcontroller.addPost(qualification, role, price);
			System.out.println("\nPosted Successfully ");
		} else
	...
	private void modifyHrDetails() {
		...
		if (input == 1) {
			...
			hrcontroller.mofidydetails(name, null, null);
			...
			hrcontroller.mofidydetails(null, pass, null);
			...
			hrcontroller.mofidydetails(null, null, org);
