...
public class LoginModel {
	...
	public JSONArray getProducts(String catogory, String brand, String model, int sortOrder) {
		List<Product> products = ECommerceDb.getInstance().searchProduct(catogory, brand, model, sortOrder);
	...
	public synchronized boolean addOrder(double payment, String mail) {
...
//	}
	...
	public JSONArray getProductByBrand(String brand, int sortOrder) {

		List<Product> products = null;
		if (brand.equals("Mobile") || brand.equals("Mobile Accessories") || brand.equals("Laptop")
				|| brand.equals("Tablets")) {
			products = ECommerceDb.getInstance().searchProduct(brand, null, null, sortOrder);
		} else {
			products = ECommerceDb.getInstance().searchProduct(null, brand, null, sortOrder);
		}
