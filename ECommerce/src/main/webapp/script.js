function home() {
    ...
    <div class="d-flex">
        <div class="cat" onclick = "search('Mobile')">
            <img src="https://images.fonearena.com/blog/wp-content/uploads/2020/10/iPhone-12.jpg" class = "type">
            <span >Mobile</span>
        </div>
        <div class="cat" onclick = "search('Mobile Accessorie')">
        ...
        <div class="cat" onclick = "search('Tablet')">
					...
					for (let a = 0; a < arr.length; a++) {
						...
						var inner = `<hr><div class="products">
							...
							<ul>
								...
								<button class = "remove" ><i class="fa-solid fa-trash-can fa-beat fa-xs"></i> &nbsp;Add Review</button>
							</div>`;
...
function addAddress() {
	...
	console.log(address + "  " + number + "   " + pincode);
